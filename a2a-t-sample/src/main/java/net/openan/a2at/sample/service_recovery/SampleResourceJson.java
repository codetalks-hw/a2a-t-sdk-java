 ...
 *
 * <p>Keeps locale-specific business data (zh-CN slot names, event field labels) in resource files
 * so the Java sources stay pure ASCII.
 *
 * @since 2026-08
 */
public final class SampleResourceJson {
    ...
    public static Map<String, Object> load(String resourcePath) {
        try (InputStream inputStream = SampleResourceJson.class
                .getClassLoader()
