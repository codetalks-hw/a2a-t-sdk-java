...
/**
 * Loads the sample inputs and schemas from the classpath resources under
 * {@code sample/service-recovery/}.
 *
...
public final class ServiceRecoverySampleInputs {
    ...
    private static final String INPUT_RESOURCE =
            "sample/service-recovery/client/input-with-text.txt";

    private static final String STRUCTURED_INPUT_RESOURCE =
            "sample/service-recovery/client/input-with-data.json";

    private static final String DATA_SCHEMA_RESOURCE =
            "sample/service-recovery/client/schema.json";
    ...
    /**
     * Loads the natural-language subscription request from
     * {@code sample/service-recovery/client/input-with-text.txt}.
     *
    ...
    /**
     * Loads the structured subscription request consumed by
     * {@code generateNotificationPromptFromDataWithSchema} from
    ...
    /**
     * Loads the data schema guiding the structured extraction of
     * {@code generateNotificationPromptFromDataWithSchema} from
     * {@code sample/service-recovery/client/schema.json}.
     *
     * <p>The schema describes the two input-with-data fields (type, description, required) and is
     * handed to the SDK verbatim; the SDK prints its entries into the LLM slot-extraction prompt.
     *
    ...
    /**
     * Loads the parameter schema handed to {@code A2ATServer.validateAndFillingNotificationData}
     * from {@code sample/service-recovery/server/schema.json}.
     *
